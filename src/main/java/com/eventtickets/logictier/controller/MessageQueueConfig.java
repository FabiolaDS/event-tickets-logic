...
public class MessageQueueConfig {
	...
	@Bean
	public Queue removeCreditCardQueue() {
		return new Queue("removeCreditCard");
	}

	@Bean
	public Binding removeCreditCardBinding(DirectExchange logicTierExchange,
		Queue removeCreditCardQueue) {
		return BindingBuilder
			.bind(removeCreditCardQueue)
			.to(logicTierExchange)
			.with("removeCreditCard");
	}
