...
@Component
public class RestTicketRepository extends RestRepository
	implements TicketRepository {

	public RestTicketRepository(RestTemplate restTemplate,
	...
	public List<Ticket> getByUserId(long id) {
		try {
			ResponseEntity<List<Ticket>> response = rest()
				.exchange(url("byUser", id),
					HttpMethod.GET, null,
