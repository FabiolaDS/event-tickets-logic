...
@Component
public class RestCreditCardRepository extends RestRepository implements CreditCardRepository{

    public RestCreditCardRepository(@Value("${eventTicket.data.url}") String dataUrl, RestTemplate restTemplate) {
